...
EXERCISE_GUIDES = {
    ...
    "reaction_time": (
        ...
        "Space as fast as you can. Clicking before the stimulus appears counts "
        "as 'too early' and the round is repeated.\n\n"
        "Choice: A colored shape appears — press the matching number key "
        "(1-4) for the correct color. Speed and accuracy both matter.\n\n"
        "Go/No-Go: Green circle = click (Go). Red circle = don't click "
