...
class SplitAttentionMenuScreen(BaseMenuScreen):
    ...
    def build(self, **kwargs) -> None:
        ...
        self._create_column_menu(
            ...
            columns=[
                ("SEQUENTIAL", [
                    ("Word 300ms · Shape 250ms", run("sequential", 300, 250)),
                    ("Word 250ms · Shape 200ms", run("sequential", 250, 200)),
                    ("Word 200ms · Shape 180ms", run("sequential", 200, 180)),
                    ("Word 180ms · Shape 150ms", run("sequential", 180, 150)),
                ...
                ("SIMULTANEOUS", [
                    ("Word 300ms · Shape 250ms", run("simultaneous", 300, 250)),
                ...
                ("RAPID", [
                    ("Word 250ms · Shape 200ms", run("rapid", 250, 200)),
                    ("Word 200ms · Shape 180ms", run("rapid", 200, 180)),
                    ("Word 180ms · Shape 150ms", run("rapid", 180, 150)),
                    ("Word 150ms · Shape 120ms", run("rapid", 150, 120)),
